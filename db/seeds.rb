...
maxou = User.create!(email: "maxou@gmail.com", password: "maxouxou", pseudo: "Max le conquérant")
osque = User.create!(email: "osque@gmail.com", password: "oscarito", pseudo: "Oscaritoto")
